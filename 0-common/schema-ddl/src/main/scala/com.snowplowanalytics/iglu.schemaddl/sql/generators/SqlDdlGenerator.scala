 ...
 */
abstract class SqlDdlGenerator {
  /**
...
object SqlDdlGenerator {
  ...
  val selfDescSchemaColumns = List(
    Column("schema_vendor", SqlVarchar(128), Set(), Set(Nullability(NotNull))),
    Column("schema_name", SqlVarchar(128), Set(), Set(Nullability(NotNull))),
    Column("schema_format", SqlVarchar(128), Set(), Set(Nullability(NotNull))),
    Column("schema_version", SqlVarchar(128), Set(), Set(Nullability(NotNull)))
  )

  // Snowplow-specific columns
  val parentageColumns = List(
    Column("root_id", SqlChar(36), Set(), Set(Nullability(NotNull))),
    Column("root_tstamp", SqlTimestamp, Set(), Set(Nullability(NotNull))),
    Column("ref_root", SqlVarchar(255), Set(), Set(Nullability(NotNull))),
    Column("ref_tree", SqlVarchar(1500), Set(), Set(Nullability(NotNull))),
    Column("ref_parent", SqlVarchar(255), Set(), Set(Nullability(NotNull)))
  )
